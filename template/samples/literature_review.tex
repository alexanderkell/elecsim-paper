...
%	\begin{tabular}{|l|c|c|c|c|c|}
	\begin{tabular}{lccccc} \toprule
		...
		SEPIA                                    & \checkmark           & $\times$                             & \checkmark      & Demand                     & \checkmark                        \\ 
		EMCAS                                    & $\times$                    & \checkmark                    & \checkmark      & Outages                    & \checkmark                        \\ 
		NEMSIM                                   & ?              & \checkmark                    & \checkmark      & $\times$                          & $\times$                                 \\ 
		AMES                                     & \checkmark           & $\times$                             & Day-ahead       & $\times$                          & $\times$                                 \\ 
		PowerACE                                 & $\times$                    & \checkmark                    & \checkmark      & Outages/Demand             & \checkmark                        \\ 
		MACSEM                                   & ?              & $\times$                             & \checkmark      & $\times$                          & \checkmark                        \\ 
		GAPE$\times$                                    & ?              & $\times$                             & Day-ahead       & $\times$                          & \checkmark                        \\ 
		EMLab                                    & \checkmark           & \checkmark                    & Futures         & $\times$                          & \checkmark                        \\ 
