...
\begin{table*}[t]
	\begin{tabular*}{\textwidth}{|l|c|c|c|c|c|}
		\hline
\multicolumn{1}{|c|}{\textbf{Tool name}} & \textbf{Open Source} & \textbf{Investment} & \textbf{Market} & \textbf{Stochastic Inputs} & \textbf{Generalisable} \\ \hline
SEPIA                                    & \checkmark           & x                   & \checkmark      & Demand                     &                        \\ \hline
...
PowerACE                                 & x                    & \checkmark          & \checkmark      & Outages/Demand             & EU                     \\ \hline
